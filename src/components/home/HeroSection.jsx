            ...
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8">
                <div className="space-y-5 max-w-4xl mx-auto text-center">
                    ...
                    <h2 className="text-4xl text-gray-800 font-extrabold mx-auto md:text-5xl">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5]"> Connect with Tech Enthusiasts</span>
                ...
                <div className="">
                    <Image src="/assets/HeroImage2.png" width={500} height={500} className="max-w-screen-2xl mx-auto " alt=""></Image>
                </div>
            </div>
        </section>
    );
