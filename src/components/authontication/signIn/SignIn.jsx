            ...
            <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                ...
                <div className="bg-gray-100 shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    ...
                    <div className="relative">
                        ...
                        <p className="inline-block w-fit text-sm bg-gray-200 px-2 absolute -top-2 inset-x-0 mx-auto">Or continue with</p>
                    </div>
                    <form
                        className="space-y-5"
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none shadow-sm rounded-lg"
                            />
                        </div>
